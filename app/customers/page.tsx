...
export default function CustomersPage() {
    ...
    if (loading) {
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="text-center">Ielādē klientus...</div>
            </div>
        );
    }
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            <div className="mb-8">
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Klienti</h1>
                <p className="text-gray-600">Pārvaldiet klientu informāciju un auto vēsturi</p>
            </div>

            <div className="mb-6">
                <input
                    type="text"
                    placeholder="Meklēt pēc vārda, tālruņa, numura zīmes vai auto..."
                    value={searchTerm}
            ...
            <div className="mb-4 text-lg text-gray-700">
                Kopā klienti: <span className="font-bold text-blue-600">{filteredCustomers.length}</span>
            </div>

            <div className="space-y-6">
                {filteredCustomers.length === 0 ? (
                    <div className="text-center py-12 bg-gray-50 rounded-lg">
                        <p className="text-gray-500 text-lg">Klienti nav atrasti.</p>
                    </div>
                ) : (
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="text-right">
                                    <div className="text-sm text-gray-600">Darba uzdevumi kopā</div>
                            ...
                            <div className="border-t border-gray-200 pt-4">
                                <h4 className="text-lg font-semibold text-gray-700 mb-3">
                                    Transportlīdzekļi ({customer.cars.length})
                                </h4>
